            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {featuredPortfolio.length > 0 ? (
                  ...
                  // Placeholder grid while loading or empty
                  [1, 2, 3, 4].map(i => (
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {services.length > 0 ? services.map((s) => (
                  <div key={s._id} className="border border-gray-800 p-8 hover:border-gray-600 transition-colors duration-300">
                ...
                )) : ['Weddings', 'Portraits', 'Events'].map(name => (
                  <div key={name} className="border border-gray-800 p-8 hover:border-gray-600 transition-colors duration-300">
                    <h3 className="text-2xl font-light mb-3 tracking-wide">{name}</h3>
